...
import { Alert, Button, Heading, Input, useClipboard } from "@chakra-ui/react";
import { ethers, HDNodeWallet } from "ethers";
import { useState } from "react";

export default function WalletGenuineNumberGenerator() {
        ...
        {wallet && (
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {hasCopied && value === wallet.publicKey ? "复制成功!" : "复制"}
              </Button>
            </div>
